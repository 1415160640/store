...
font {
 ...
 <script type="text/javascript">
	...
	function check() {
		...
		$.post("UserServlet?method=CheckUserName" , {username:username} , function(data , status){
			//alert(data);
			if(data == 1){
...
<div class="container" style="width:100%;background:url('${pageContext.request.contextPath}/img/ad/2.jpg');">
<div class="row"> 
	...
	<div class="col-md-8" style="background:#fff;padding:40px 80px;margin:30px;border:7px solid #ccc;">
		...
		<form class="form-horizontal" style="margin-top:5px;" action="${pageContext.request.contextPath}/UserServlet?method=userRegist" method="post">
			 <div class="form-group">
			    ...
			    <div class="col-sm-6">
			      <input type="text" name="username" class="form-control" id="username" placeholder="请输入用户名"  onblur="check()"><span id="span01"></span>
			    </div>
			  </div>
			   <div class="form-group">
