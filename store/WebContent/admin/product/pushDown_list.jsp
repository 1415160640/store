								...
								<c:forEach items="${page.list}" var="p" varStatus="status">
										<tr onmouseover="this.style.backgroundColor = 'white'"
											...
											<td align="center" style="HEIGHT: 22px">
												<%--上架pushUpProduct --%>
												<a href="${pageContext.request.contextPath}/ProductServlet?method=pushUpProduct&pid=${p.pid}">
													<img src="${pageContext.request.contextPath}/img/admin/ok.png" width="20" height="20" border="0" style="CURSOR: hand">
												</a>
											</td>
											<td align="center" style="HEIGHT: 22px">
												<%--上架pushUpProduct --%>
												<a href="${pageContext.request.contextPath}/ProductServlet?method=deleteProduct&pid=${p.pid}">
