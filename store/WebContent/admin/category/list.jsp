	...
	<HEAD>
		...
		<script type="text/javascript">
			function addCategory(){
				window.location.href = "${pageContext.request.contextPath}/CategoryServlet?method=addCategoryUI";
			}
		</script>
	</HEAD>
	<body>
								...
								<c:forEach items="${page.list}" var="c" varStatus="status">
										<tr onmouseover="this.style.backgroundColor = 'white'"
											...
											<td align="center" style="HEIGHT: 22px">
												<a href="${pageContext.request.contextPath}/CategoryServlet?method=editCategoryUI&cid=${c.cid}">
													<img src="${pageContext.request.contextPath}/img/admin/edit.png" border="0" style="CURSOR: hand">
												</a>
											</td>
									
											<td align="center" style="HEIGHT: 22px">
												<a href="${pageContext.request.contextPath}/CategoryServlet?method=deleteCategory&cid=${c.cid}">
